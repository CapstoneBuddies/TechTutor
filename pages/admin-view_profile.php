...
<div class="container-fluid">
    <div class="row">
        ...
        <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar" style="padding: 15px;">
            ...
            <button class="btn" style="background-color: #0F52BA; color: white; font-size: 20px;"> <i class="bi bi-person" style="color: white;">
                Profile
            </a></button> </i>
            </li>
            <li class="nav-item">
...
<br>                                <!-- TechGuru-->
        <div class="row" style="height: 100vh;">
            <div class="col-12" style="background-color: #f8f9fa; height: 100%;">
            <h2 style="margin:10px 20px 0px 20px;">TechGuru</h2>
            <div class="d-flex justify-content-end mb-3">
                <input type="text" class="form-control" style="width: 35%;" placeholder="Search">
                <a href="view-all-techkids.php" class="btn btn-primary" ><img src="../assets/img/search-interface-symbol.png" alt="Default Image" width="20" height="20"></a>
