  ...
  <nav id="navmenu" class="navmenu">
    ...
    <i class="mobile-nav-toggle d-xl-none bi bi-list"></i>
      ...
      <div class="search-bar d-flex">
        ...
        <button class="btn btn-primary" onclick="createClasses()" >Create Class</button>
      </div>
      </div>
      ...
      <div class="row">
        ...
        <tr>
          ...
          <td>
            <a href="join-meeting.php?class=ComputerProgramming" class="btn btn-primary" style="background-color: #0F52BA;">Join Meeting</a>
          </td>
        </tr>
        <tr>
          <td>Jane Smith</td>
          ...
          <td>
            <a href="join-meeting.php?class=ComputerNetworking" class="btn btn-primary" style="background-color: #0F52BA;">Join Meeting</a>
          </td>
        </tr>
        <tr>
          <td>Emily Johnson</td>
          ...
          <td>UI/UX Design</td>
          <td>
            <a href="join-meeting.php?class=UIUXDesign" class="btn btn-primary" style="background-color: #0F52BA;">Join Meeting</a>
          </td>
        </tr>
          </tbody>
        </table>
