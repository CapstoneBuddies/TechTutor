...
<div class="container-fluid">
  ...
  <nav id="navmenu" class="navmenu">
    ...
    <i class="mobile-nav-toggle d-xl-none bi bi-list"></i>
      ...
      <h1 class="h2">Available Classes</h1>
      ...
      <div class="row">
        ...
        <tr>
          ...
          <td>
            <button class="btn btn-primary" style="background-color: #0F52BA;" onclick="openUpdateModal('Computer Programming', 'lorem ipsum bantay ka bata 163')">Update Class</button>
          </td>
        </tr>
        <tr>
          ...
          <td>
            <button class="btn btn-primary" style="background-color: #0F52BA;" onclick="openUpdateModal('Computer Networking', 'lorem ipsum bantay ka bata 163')">Update Class</button>
          </td>
        </tr>
        <tr>
          <td>UI/UX Design</td>
          ...
          <td>
            <button class="btn btn-primary" style="background-color: #0F52BA;" onclick="openUpdateModal('UI/UX Design', 'lorem ipsum bantay ka bata 163')">Update Class</button>
          </td>
        </tr>
          </tbody>
        </table>
