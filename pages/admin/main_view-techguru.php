        ...
        <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar">
            <div class="position-sticky">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link d-flex align-items-center px-3 py-2 rounded active" href="TechGurus">
                            <i class="bi bi-people"></i>
                            <span class="ms-2">TechGurus</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link d-flex align-items-center px-3 py-2 rounded" href="TechKids">
            ...
            <div class="table-responsive" style="max-height: calc(100% - 100px); overflow-y: auto;">
                <table class="table table-striped table-sm">
                    ...
                    <tbody id="techGuruTable">
                        <?php
                            if (!empty($techguru)) {
                                foreach ($techguru as $guru) {
                                    if ((bool)$guru['status']) {
                                        $statusClass = getStatusBadgeClass($guru['status']);
                                        $statusText = ucfirst(normalizeStatus($guru['status']));
                                        
                                        echo "<tr>
                                            <td class='text-center'>{$guru['uid']}</td>
                                            <td>{$guru['first_name']} {$guru['last_name']}</td>
                                            <td>{$guru['email']}</td>
                                            <td>{$guru['course']}</td>
                                            <td>{$guru['schedule']}</td>
                                ...
                                echo "<tr><td colspan='8'>No active TechGurus found.</td></tr>";
                            }
                        ?>
                    </tbody>
                </table>
