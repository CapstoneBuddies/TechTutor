      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
            <h1 data-aos="fade-up">Empowering Minds</h1><h1 data-aos="fade-up">Building Futures</h1>
            <p data-aos="fade-up" data-aos-delay="100">Equip individuals with the knowledge and skills 
              they need to succeed in the digital age 
              By providing accessible and engaging IT online education
              We empower minds to reach their full potential 
              and build brighter futures.</p>
          </div>
